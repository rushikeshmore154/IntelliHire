...
const Practice = () => {
  ...
  const [interviewState, setInterviewState] = useState({
    ...
    chatHistory: [] as { type: 'question' | 'answer', content: string, timestamp: string }[],
  });
  ...
  const [results] = useState({
    ...
    detailedFeedback: "You demonstrated solid technical knowledge and problem-solving skills. Your explanations were clear and well-structured. To improve, consider providing more specific examples from your experience and speaking with greater confidence about your abilities."
  });
  ...
  const handleSetupSubmit = () => {
    if (!setupData.role || !setupData.difficulty || !setupData.roundType) {
      toast({
  ...
  const handleAnswerSubmit = () => {
    ...
    if (interviewState.currentQuestion < interviewState.totalQuestions) {
      const nextQuestion = interviewState.questions[interviewState.currentQuestion];
      newChatHistory.push({
        type: 'question',
